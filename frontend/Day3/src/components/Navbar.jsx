  ...
  return (
    <div className="app">
      <div className="header">
        ...
        <div className="nav">
          <ul>
            <li><Link to="/navbar-link-1"><a href="#"> Home</a></Link></li>
            ...
            {/* <li><Link to="/ConatctPage"><a href="#"> Contact</a></Link></li> */}
...
<ul>
    ...
    <li></li>
    <li></li>
    <li><Link to="/sidebar-link-2">Price</Link></li>
    <li></li>
    <li></li>
          ...
          {showDropdown && (
            <div className="dropdown">
              <ul>
                ...
                <li><Link to="/ProfilePage"><a href="#">Admin</a></Link></li>
              </ul>
            </div>
